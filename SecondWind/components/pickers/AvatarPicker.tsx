            ...
            <Pressable onPress={openModal} className="active:opacity-80">
                {image ? (
                    <View className="relative">
                        <Image
                            source={{ uri: image }}
                            className="w-32 h-32 rounded-full border-4 border-white dark:border-slate-800 shadow-sm"
                        />
                        <View className="absolute bottom-0 right-0 bg-blue-600 p-2 rounded-full border-2 border-white dark:border-slate-800 shadow-lg">
                            <Ionicons name="camera" size={16} color="white" />
                        </View>
                    </View>
                ) : (
                    <View className="w-32 h-32 rounded-full bg-slate-100 dark:bg-slate-800 border-2 border-dashed border-slate-300 dark:border-slate-700 items-center justify-center">
                        <Ionicons
            ...
            >
                <View className="flex-1 bg-black/60 justify-end">
                    ...
                    >
                        ...
                        <View className="px-6">
                            <Text className="text-xl font-bold text-gray-900 dark:text-white mb-8 mt-2 text-center">
                            ...
                            <View className="flex-row justify-around mb-4">
                                <Pressable onPress={takePhoto} className="items-center active:opacity-60">
                                    ...
                                    <Text className="text-gray-700 dark:text-gray-300 font-semibold text-base">Камера</Text>
                                </Pressable>
                                ...
                                <Pressable onPress={pickImage} className="items-center active:opacity-60">
                                    ...
                                    <Text className="text-gray-700 dark:text-gray-300 font-semibold text-base">Галерея</Text>
                                </Pressable>
                            </View>
                        </View>
                    </Animated.View>
